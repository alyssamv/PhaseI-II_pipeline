source(file.path(getwd(), "code/fns_og.R"))
...
response.null = list(
  ...
  c(0.4, 0.35, 0.3, 0.25, 0.1), # CD = 1
  c(0.3, 0.4, 0.35, 0.25, 0.1) # CD = 3
)

# Response curves when drug is effective
response.alt = list(
  c(0.1, 0.2, 0.45, 0.6, 0.7), # correct dose = 4
  rep(0.65, n.dose), # CD = 1
...
#save.image(file = file.path(getwd(), "term project/sims_null2.RData"))
